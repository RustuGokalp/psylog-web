...
export default function HeroSection({ about }: HeroSectionProps) {
  return (
    <section className="relative overflow-hidden bg-linear-to-br from-violet-500 via-purple-400 to-pink-400">
      ...
      <Butterfly
        className="pointer-events-none absolute bottom-8 left-8 h-16 w-16 text-pink-100/25"
        aria-hidden="true"
      />
      <Star
        className="pointer-events-none absolute top-12 left-1/3 h-8 w-8 text-white/20"
        aria-hidden="true"
      />
